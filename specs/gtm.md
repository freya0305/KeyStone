...
| 5–9   | Convert pilot to paid contract; approach 2–3 more universities + agencies | First SGD 15–20K pilot-expansion contract; 3–5 agency deals |
...
**Aspirational**: "one semester free, then paid contract." **Realistic**: 18–24 months. Plan capital accordingly: minimum SGD 40K reserves required to survive to first university contract (Month 9) with a 2-month safety buffer.
...
- Price the first paid contract at SGD 15–20K to keep it within director approval threshold; frame as "pilot expansion" to avoid procurement process
...
**What the brief should NOT count on**: paid Google/Facebook acquisition. CAC of SGD 40–80 against LTV of SGD 36 (monthly plan only; annual plan cancelled) is structurally unprofitable.
...
2. **B2C conversion**: 1–2% paid conversion among non-university users (2–5% is full range; 1–2% non-university is the signal)

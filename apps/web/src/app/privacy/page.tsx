        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600">
              KeyStone is a resume tailoring service operated by KeyStone Pte. Ltd. (registered in
              Singapore). This Privacy Policy explains how we collect, use, and protect your
              personal data in accordance with Singapore&apos;s Personal Data Protection Act (PDPA)
              2012.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600">
              ...
              <li>
                <strong>Resume content</strong> — uploaded by you
              </li>
              <li>
                <strong>Job descriptions</strong> — uploaded or pasted by you
              </li>
              <li>
                <strong>Application tracking data</strong> — employers, roles, status
              </li>
              <li>
                <strong>Consent preferences</strong> — your choices about how we use your data
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 mt-3">
              Anthropic is configured to retain zero data — your content is not stored or used for
              AI training.
            </p>
            <p className="text-gray-600 mt-3">
              All Claude API calls are processed in data centers located in Asia Pacific
              (Tokyo/Singapore).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600">
              <li>
                <strong>Resume data</strong> — retained until you delete your account or request
                deletion
              </li>
              <li>
                <strong>Application tracking data</strong> — retained for 2 years after last
                activity
              </li>
              <li>
                <strong>AI processing logs</strong> — retained for 90 days
              </li>
            </ul>
          </section>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  name: 'Storage',
                  required: true,
                  desc: 'Store your resume and application data so we can provide job matching services.',
                },
                {
                  name: 'AI Processing',
                  required: true,
                  desc: 'Send your resume and job descriptions to Claude API for analysis.',
                },
                {
                  name: 'B2B Sharing',
                  required: false,
                  desc: 'Allow recruiters to view anonymized application statistics (no personal data shared).',
                },
                {
                  name: 'Outcome Tracking',
                  required: true,
                  desc: 'Track application outcomes to improve suggestions over time.',
                },
                {
                  name: 'Marketing',
                  required: false,
                  desc: 'Receive newsletters and promotional emails about KeyStone.',
                },
                {
                  name: 'AI Training',
                  required: false,
                  desc: 'Allow anonymized feedback to improve AI model performance.',
                },
              ].map((consent) => (
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600">
              <li>
                We use <strong>essential cookies</strong> for authentication (Clerk).
              </li>
              <li>
                We use <strong>analytics cookies</strong> (PostHog) to understand how users navigate
                the service — no personal data is shared.
              </li>
              <li>
          ...
          <section>
            ...
            {/* TODO: Replace with actual Singapore DPO contact once engaged */}
          </section>

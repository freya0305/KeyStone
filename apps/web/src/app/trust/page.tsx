      ...
      <div className="container mx-auto px-4 py-16 max-w-3xl">
        ...
        <div className="prose prose-gray max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600">
              All resume and application data is stored on servers located in Singapore.
              Your data never leaves Singapore unless you explicitly consent to processing
              for AI analysis, in which case it is sent to Anthropic&apos;s Claude API and
              is not retained by them.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              KeyStone automatically detects and masks Singapore NRIC numbers (and FIN numbers)
              in all uploaded documents. This happens before any AI processing, ensuring your
              identity numbers are never exposed to AI models or stored in plain text.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 mb-4">
              Under PDPA, you have full control over your data. KeyStone requires your consent
              for the following purposes:
            </p>
            <div className="space-y-3">
              {[
                { name: "Account Registration", required: true, desc: "Required to create and maintain your account." },
                { name: "Resume & Application Storage", required: true, desc: "Store your data so we can provide job matching services." },
                { name: "AI Processing", required: true, desc: "Send to Claude API for resume and job analysis." },
                { name: "Application Outcome Tracking", required: true, desc: "Track outcomes to improve suggestions over time." },
                { name: "Marketing Communications", required: false, desc: "Receive newsletters and promotional emails." },
                { name: "AI Model Improvement", required: false, desc: "Allow anonymized feedback for model training." },
              ].map(consent => (
          ...
          <section>
            ...
            <p className="text-gray-600">
              When you use AI features (resume analysis, job matching, JD generation), your data
              is sent to Anthropic&apos;s Claude API. KeyStone has a Data Processing Agreement with
